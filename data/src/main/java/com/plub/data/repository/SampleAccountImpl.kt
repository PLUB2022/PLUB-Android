...
class SampleAccountImpl @Inject constructor(private val sampleApi: SampleApi) : SampleAccountRepository {
    ...
    override fun checkNickname(): Flow<UiState<SampleAccount>> = flow {
        ...
        sampleApi.checkNickname("123").enqueue(object: retrofit2.Callback<SampleAccountResponse> {
            override fun onResponse(call: Call<SampleAccountResponse>, response: Response<SampleAccountResponse>) {
