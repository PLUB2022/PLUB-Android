...
object Endpoints {
    ...
    object PLUBBING {
        ...
        const val MODIFY_GATHERING_INFO = PLUBBING_ID_URL
        const val MODIFY_GATHERING_PULL_UP = "$RECRUIT_URL/pull-up"
        ...
        object NOTICE {
            ...
            const val COMMENT_DELETE = "$PLUBBING_ID_URL/notices/{noticeId}/comments/{commentId}"
