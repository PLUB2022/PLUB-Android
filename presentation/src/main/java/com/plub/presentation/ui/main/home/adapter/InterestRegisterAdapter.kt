...
class InterestRegisterAdapter(private var mlist : List<String>) : RecyclerView.Adapter<InterestRegisterAdapter.ViewHolder?>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InterestRegisterAdapter.ViewHolder {
...
//            }
    ...
    override fun onBindViewHolder(holder: InterestRegisterAdapter.ViewHolder, position: Int) {
