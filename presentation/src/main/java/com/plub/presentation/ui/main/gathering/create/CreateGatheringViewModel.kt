...
import com.plub.presentation.ui.main.gathering.create.finish.CreateGatheringFinishPageState
import com.plub.presentation.ui.main.gathering.create.preview.CreateGatheringPreviewPageState
...
class CreateGatheringViewModel @Inject constructor(
    ...
    fun onClickNextButtonInPreViewPage() {
        uploadPlubbingMainImage { imgUrl ->
            createGathering(imgUrl) { response ->
                updateUiState { uiState ->
                    uiState.copy(plubbingId = response.plubbingId)
                }
